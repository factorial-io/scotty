...
- **path:** cli/map-cli-app-cp-permission-and-size-limit.md
...
- **path:** cli/map-cli-app-create-registry-middleware-allowlist.md
...
- **path:** cli/map-cli-app-create-robots-header-default.md
...
- **path:** configuration/map-config-directory-git-tracking.md
...
- **path:** traefik/map-default-backend-landing-page.md
...
- **path:** traefik/map-default-backend-security-model.md
...
- **path:** configuration/map-docker-image-excludes-secrets.md
...
- **path:** traefik/map-load-balancer-support.md
...
- **path:** observability/map-observability-config-files.md
...
- **path:** observability/map-observability-data-retention.md
...
- **path:** observability/map-observability-local-access.md
...
- **path:** observability/map-observability-stack-architecture.md
...
- **path:** configuration/map-onepassword-secret-resolution.md
...
- **path:** workflow/map-pre-push-hook-cargo-husky.md
...
- **path:** architecture/map-rustls-crypto-provider-init.md
...
- **path:** observability/map-scotty-metrics-families.md
...
- **path:** architecture/map-scotty-product-scope.md
...
- **path:** architecture/map-scotty-server-module-map.md
...
- **path:** cli/map-scottyctl-app-cp.md
...
- **path:** traefik/map-traefik-per-app-proxy-network.md
...
- **path:** cli/practice-app-cp-path-spec-and-pipe-mode.md
...
- **path:** cli/practice-cli-app-purge-vs-destroy.md
...
- **path:** cli/practice-cli-app-shell-security-characteristics.md
...
- **path:** configuration/practice-config-env-var-override-convention.md
...
- **path:** workflow/practice-contributor-setup-instructions-belong-in-the-root-readme.md
- **tags:** documentation, readme, conventions
- **derived_from:** 802ace42-0a9d-4291-90e2-56e2ca6b5954:practice:1
...
- **path:** traefik/practice-default-backend-configuration.md
...
- **path:** configuration/practice-dotenv-precedence-scotty.md
...
- **path:** configuration/practice-enable-telemetry-env-var.md
...
- **path:** cli/practice-file-transfer-http-tar-streaming.md
...
- **path:** frontend/practice-frontend-uses-bun.md
...
- **path:** workflow/practice-git-rules.md
...
- **path:** traefik/practice-local-dev-traefik-prereq.md
...
- **path:** traefik/practice-localhost-subdomain-dns-gotcha.md
...
- **path:** configuration/practice-never-store-real-bearer-tokens-in-config.md
...
- **path:** observability/practice-observability-stack-swappable.md
...
- **path:** workflow/practice-primary-vcs-workflow-is-jj-never-depend-on-git-commit-hooks.md
- **tags:** vcs, jj, git-hooks, workflow
- **relates_to:** practice-git-rules, map-pre-push-hook-cargo-husky
- **derived_from:** 802ace42-0a9d-4291-90e2-56e2ca6b5954:practice:0

## practice-project-management-beans

- **kind:** practice
- **title:** Use beans CLI for issue tracking, not ad hoc todo lists
- **path:** workflow/practice-project-management-beans.md
...
- **path:** workflow/practice-release-process-automation.md
...
- **path:** configuration/practice-root-folder-must-match-docker-mount-path.md
...
- **path:** cli/practice-scottyctl-access-token-precedence.md
...
- **path:** configuration/practice-settings-config-precedence.md
...
- **path:** workflow/practice-testing-conventions.md
...
- **path:** traefik/practice-traefik-middleware-ordering.md
...
- **path:** traefik/practice-traefik-network-migration-requires-rebuild.md
