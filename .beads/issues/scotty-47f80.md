...
depends_on:
  scotty-06fec: blocks
created_at: 2025-10-25T00:37:26.668911+00:00
updated_at: 2025-11-24T20:17:25.546708+00:00
closed_at: 2025-10-26T16:20:02.191752+00:00
---

# Description

Instrument SharedAppList to track number of apps, their states (stopped/starting/running/etc), services per app, and health check age.

# Design

Add AppList metrics to ScottyMetrics struct:
...
Note: Requires access to SharedAppList from metrics, may need to pass via background task or add to AppState.

# Acceptance Criteria

- App metrics exported to OTLP
...
- Minimal performance overhead from sampling
