...
- [x] 10.5 Manual scenario: stop an app and confirm it is not attached; remove an app directory by hand and confirm its empty proxy network is pruned while a network with a live foreign container is left alone.
